...
- Fan-test dwell waits until the relevant temperatures have stopped moving, with a timeout and abort ceilings. Do not add another fixed kitchen-timer hold.
