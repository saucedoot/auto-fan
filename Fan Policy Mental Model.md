...
**Body text below is historical Path A only.** Path B next work is the Home curve-seed **plan** in the Current snapshot of [IMPLEMENTATION.md](IMPLEMENTATION.md) — not GPU-confirmation architecture debate.
