...
- **Next slice:** Everyday coarse probes (Phase 1 plan slice 4: Idle observe reuse; Everyday 20/40/70/100 + refine 55/85 on Low-movers after Low **Completed**; per-heat 30 min cap). Do not start Hot, confirmation-on-lamp, gap-fill, Home curve editing, or D6 in that slice. D6 Hold lost-temp abort remains a small optional safety PR in Edges / Later — not the locked next experiment slice.
